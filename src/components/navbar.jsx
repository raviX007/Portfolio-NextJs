  ...
  return (
    <div className="h-full flex items-center justify-between px-4 sm:px-8 md:px-12 lg:px-20 xl:px-48 text-xl">
      ...
      <div className=" md:hidden lg:flex xl:w-1/3 xl:justify-center">
        ...
        >
          <span className="text-white mr-1">Sun</span>
          <span className="w-12 h-8 rounded bg-white text-black flex items-center justify-center">.dev</span>
        </Link>
      </div>
      {/* SOCIAL */}
      <div className='hidden md:flex gap-4 w-1/3'>
        <Link href="https://github.com/raviX007?tab=repositories">
        <Image src="/github.png" alt="" width={24} height={24}/>
        </Link>
        <Link href="https://www.linkedin.com/in/ravi-raj-792a66221/">
        <Image src="/linkedin.png" alt="" width={24} height={24}/>
        </Link>
        
        <Link href="mailto:raviraj14y@gmail.com">
        <Image src="/gmail.png" alt="" width={24} height={24}/>
        </Link>
        <Link href="https://leetcode.com/rajx02/">
